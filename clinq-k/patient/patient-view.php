	...
	<section id="appointment" class="d-flex">
		<div class="container">
			...
			<div class="section-appointment">
				<h3>Sla<span>hla</span></h3>
				<p data-translate="Upcoming Scheduled Appointments">Here is the list of your upcoming scheduled
					appointments.</p>
			...
			<div class="wrap-table100">
				<div class="table">
					...
					<div class="trow header">
						<div class="cell" data-translate="Doctor">
							Doctor
						</div>
						<div class="cell" data-translate="Start Time">
							Start Time
						</div>
						<div class="cell" data-translate="End Time">
							End Time
						</div>
						<div class="cell" data-translate="Date">
							Date
						</div>
						<div class="cell" data-translate="Day">
							Day
						</div>
						<div class="cell" data-translate="Service">
							Service
						</div>
					...
					<?php
					$user = new Patient();
					$result = $user->displaySchedulel();

					while ($data = mysqli_fetch_assoc($result)) {
						if ($row['id'] == $data['patientID'] && $date <= $data['id']) { ?>
